...
class Cell:
    all = []
    cell_count= settings.MID_CELL_COUNT
    ...
    def left_click_actions(self, event):
        ...
        if self.is_mine:
            ...
            if Cell.cell_count == settings.MID_MINES_COUNT:
                Cell.stop_timer()
    ...
    def restart_game(self):
        ...
        for cell in Cell.all:
            ...
            Cell.cell_count = settings.MID_CELL_COUNT
            Cell.randomize_mines()
    ...
    def randomize_mines():
        ...
        picked_cells = random.sample(Cell.all, settings.MID_MINES_COUNT)
